...
class FinetuningArguments(
    ...
    aux_enable: bool = field(
        default=False,
        metadata={"help": "Whether or not to enable the auxiliary loss."},
    )
    aux_every: int = field(
        default=1,
        metadata={"help": "Number of steps to update the auxiliary loss."},
    )
    lambda_multilinconsistency: float = field(
        default=0.0,
        metadata={"help": "The lambda for the multilinconsistency loss."},
    )
    hs_layer_index: int = field(
        default=12,
        metadata={"help": "The layer index for the MLC loss."},
    )
    consistency_tau: float = field(
        default=0.2,
        metadata={"help": "The tau for the consistency loss."},
    )
    
    
    extractor_dim: Optional[int] = field(
        default=512,
        metadata={"help": "The hidden dimension for the multilingual representation."},
    )

    representation_type: str = field(
        default="linear",
        metadata={"help": "The type of the representation."},
    )
