...
class DatasetAttr:
    ...
    prompt_zh: Optional[str] = "prompt_zh"
    prompt_ru: Optional[str] = "prompt_ru"
    prompt_ja: Optional[str] = "prompt_ja"
    prompt_bn: Optional[str] = "prompt_bn"
    prompt_sw: Optional[str] = "prompt_sw"
    prompt_ur: Optional[str] = "prompt_ur"
    prompt_ps: Optional[str] = "prompt_ps"
    prompt_ku: Optional[str] = "prompt_ku"
    prompt_ar: Optional[str] = "prompt_ar"
